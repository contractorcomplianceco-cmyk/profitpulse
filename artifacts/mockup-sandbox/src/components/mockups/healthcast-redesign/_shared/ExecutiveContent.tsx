...
import { Sparkline, DonutChart, GaugeChart, FunnelChart, TrendLine } from "./charts";
        ...
        <div className="xl:col-span-1 flex flex-col gap-4">
          ...
          <motion.div variants={itemVariants} className="bg-primary border border-primary-foreground/20 rounded-xl p-6 flex flex-col shadow-xl shadow-primary/30 relative overflow-hidden">
            ...
            <Link href="/daily-briefing" className="mt-6 block">
              <Button className="w-full text-xs h-9 bg-primary/20 text-primary-foreground border border-primary/30 hover:bg-primary hover:text-primary-foreground transition-all shadow-[0_0_15px_-3px_hsl(var(--primary)/0.3)]">
