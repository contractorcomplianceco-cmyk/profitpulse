export const macroKpis = [
  { id: 'spend', label: 'US Construction Spending', value: '$2.1T', priorValue: 1.9, trend: [1.8, 1.9, 2.0, 2.1], prefix: '', source: 'FRED' },
  { id: 'employment', label: 'Contractor Employment', value: '8.2M', priorValue: 8.0, trend: [7.8, 8.0, 8.1, 8.2], prefix: '', source: 'BLS' },
