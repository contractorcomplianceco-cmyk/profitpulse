          ...
          <motion.div key={i} variants={itemVariants} className="bg-card border border-border rounded-xl p-4 shadow-soft hover:border-primary/50 transition-all flex flex-col gap-2 relative overflow-hidden group">
            ...
            <div className="flex items-center justify-between mt-auto pt-2 border-t border-border/50">
              ...
              <div className="w-16 h-8">
                <Sparkline data={kpi.sparkline} color={accent.spark} type="area" />
              </div>
            </div>
          </motion.div>
          );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <motion.div variants={itemVariants} className="bg-card border border-border rounded-xl p-6 flex flex-col shadow-soft">
              ...
              <div className="flex items-center h-[190px]">
                <div className="w-1/2 h-full">
                  <DonutChart data={revenueBreakdown} centerText="$1.25M" centerSubtext="Total Revenue" palette={revenueColorfulPalette} />
                </div>
            ...
            <motion.div variants={itemVariants} className="bg-card border border-border rounded-xl p-6 flex flex-col shadow-soft">
              ...
              <div className="flex gap-6 mb-5 h-44">
                ...
                <div className="w-1/2 flex flex-col gap-2.5 justify-center text-[13px]">
                  ...
                  <div className="flex justify-between border-b border-border pb-1.5"><span className="text-muted-foreground font-medium">Win Rate</span><span className="text-foreground font-bold">24.4%</span></div>
                  <div className="flex justify-between border-b border-border pb-1.5"><span className="text-muted-foreground font-medium">Avg Cycle</span><span className="text-foreground font-bold">31 Days</span></div>
                  <div className="flex justify-between border-b border-border pb-1.5"><span className="text-muted-foreground font-medium">Weighted</span><span className="text-foreground font-bold">$2.31M</span></div>
                  <div className="flex justify-between"><span className="text-muted-foreground font-medium">Coverage</span><span className="text-foreground font-bold">2.7x</span></div>
                </div>
              </div>
            ...
            <motion.div variants={itemVariants} className="bg-card border border-border rounded-xl p-6 flex flex-col shadow-soft">
              ...
              <div className="flex h-44 mb-3">
                ...
                <div className="w-1/2 flex flex-col gap-1.5 text-[12px] justify-center pl-4 font-medium">
                  <div className="flex justify-between"><span className="text-muted-foreground">Collected Profit</span><span className="text-foreground font-bold">$281,240</span></div>
                  <div className="flex justify-between"><span className="text-muted-foreground">Total Spend</span><span className="text-foreground font-bold">$87,540</span></div>
                  <div className="flex justify-between mt-1"><span className="text-muted-foreground">Cost per Click</span><span className="text-foreground font-bold">$2.18</span></div>
                  <div className="flex justify-between"><span className="text-muted-foreground">Cost per Lead</span><span className="text-foreground font-bold">$24.60</span></div>
                  <div className="flex justify-between"><span className="text-muted-foreground">Cost per SQL</span><span className="text-foreground font-bold">$68.23</span></div>
                  <div className="flex justify-between"><span className="text-muted-foreground">CAC</span><span className="text-foreground font-bold">$1,122</span></div>
                  <div className="flex justify-between"><span className="text-muted-foreground">ROAS (Rev)</span><span className="text-foreground font-bold">5.72x</span></div>
                  ...
                  {arAgingData.map((item, i) => (
                    <div key={i} className="flex flex-col text-[12px]">
                      <div className="flex justify-between mb-1 font-medium">
                        ...
                        <span className="text-foreground font-bold">${(item.value / 1000).toFixed(1)}k</span>
                      </div>
            ...
            <motion.div variants={itemVariants} className="bg-card border border-border rounded-xl p-6 flex flex-col shadow-soft">
              ...
              <div className="grid grid-cols-4 gap-3 mb-5 text-center text-[13px]">
                <div className="bg-secondary/30 p-2.5 rounded-lg border border-border/50 flex flex-col"><span className="text-muted-foreground font-bold mb-1 text-[10px] uppercase tracking-widest">Revenue</span><span className="font-black text-foreground">$4.21M</span></div>
                ...
                <div className="bg-primary/10 border-2 border-primary p-2.5 rounded-lg flex flex-col shadow-lg shadow-primary/20"><span className="text-primary font-extrabold mb-1 text-[10px] uppercase tracking-widest">Prob Goal</span><span className="font-black text-foreground text-base leading-none mt-0.5">78%</span></div>
              </div>
        ...
        <div className="xl:col-span-1 flex flex-col gap-4">
          ...
          <motion.div variants={itemVariants} className="bg-primary border border-primary-foreground/20 rounded-xl p-6 flex flex-col shadow-xl shadow-primary/30 relative overflow-hidden">
            ...
            <div className="flex flex-col gap-5 text-[13px]">
              ...
              <div className="bg-black/10 rounded-lg p-4 border border-white/5">
                <strong className="text-rose-300 block mb-1.5 font-extrabold tracking-wide text-[11px] uppercase">What Got Worse</strong>
              ...
              <div>
                ...
                <p className="text-primary-foreground/80">Follow up on 17 invoices, review Google Ads, 3 stale deals need next steps</p>
              </div>
              <div>
                <strong className="text-rose-200 block mb-1">At Risk</strong>
                <p className="text-primary-foreground/80">Cash pinch in 17 days, 2 clients at payment risk</p>
              </div>
              <div>
                <strong className="text-primary-foreground block mb-1">Opportunity to Push</strong>
                <p className="text-primary-foreground/80">Florida market expansion, retainer upsell, low CPC keywords</p>
              </div>
              <div>
                <strong className="text-primary-foreground/70 block mb-1">Decision Should Wait</strong>
                <p className="text-primary-foreground/80">Hiring additional salesperson, large software purchase</p>
              </div>
              
              <div className="mt-2 pt-4 border-t border-white/5">
                <strong className="text-primary-foreground block mb-2 font-semibold">Top 5 Actions Today:</strong>
